...
import { TransactionsData, TransactionsData2, TransactionsData3 } from '../Dompet/Home/TabContent';
					...
					<div className="card bg-warning invoice-card">
						<div className="card-body d-flex">
							...
							<div>
								...
								<span className="text-white fs-18">Total Panels Produced</span>
							</div>
						</div>
					</div>
				</div>
					...
					<div className="card">
						<Tab.Container defaultActiveKey={'Month'}>
							<div className="card-header d-block d-sm-flex border-0">
								<div className="me-3">
									<h4 className="card-title mb-2">Panel Activity History</h4>
									<span className="fs-12">
										Recent panel generation, dispatch & damage records
									</span>
